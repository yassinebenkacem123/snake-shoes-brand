  ...
  return (
    <section className="padding-y gap-10 flex items-center xl:flex-row flex-col ">
        <div className="padding-x">
            <h1 className="font-palanquin font-bold max-lg:text-[50px] text-[70px]">We provide you <span className="text-coral-red capitalize">super quality</span> shoes</h1>
        ...
        <img src={shoe8} className="w-[800px] max-lg:w-[600px]" alt="specail offer"  />
    </section>
  )
}
